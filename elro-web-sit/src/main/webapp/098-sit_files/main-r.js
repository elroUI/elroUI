var reactVersions = {
  ...
  "components": "1.280.22",
  "core": "1.280.22",
  "editingRendererPlugins": "1.280.22",
  "editingServices": "1.280.22",
  "editorPuk": "1.280.22",
  "fonts": "1.280.22",
  "layout": "1.280.22",
  "logger": "1.280.22",
  "qaAutomation": "1.280.22",
  "skins": "1.280.22",
  "testUtils": "1.280.22",
  "tpa": "1.280.22",
  "utils": "1.280.22",
  "wixSites": "1.280.22",
  "wixappsBuilder": "1.280.22",
  "wixappsClassics": "1.280.22",
  "wixappsCore": "1.280.22"
};
...
var packagesUtil = (function () {
    ...
    var packagesStructure = ["animations","bi","components","componentsPreviewLayer","core","documentServices","editingRendererPlugins","editingServices","editorPuk","fonts","layout","logger","qaAutomation","skins","testUtils","tpa","tpaIntegration","utils","wixSites","wixappsBuilder","wixappsClassics","wixappsCore"]
...
function wixRenderSite() {
    ...
    // Temporary workaround for lodash compat issues on iOS8
    function lodashFile() {
        function iOS8() {
            return window.navigator.userAgent.search(/OS 8_0.+like Mac.+AppleWebKit/) !== -1;
        }

        return iOS8() ? 'lodash.compat.min' : 'lodash.min';
    }
    ...
    var config = {
        ...
        paths: {
            ...
            lodash: staticServerUrl + 'services/third-party/lodash/2.4.1/dist/' + lodashFile(),
            react: {min: 'js/vendor/react-0.11.2.addons.min', source: 'js/vendor/react-0.11.2.addons'},
            ...
            TweenMax: {min: staticServerUrl + 'services/third-party/tweenmax/1.13.1/minified/TweenMax.min', source: staticServerUrl + 'services/third-party/tweenmax/1.13.1/uncompressed/TweenMax'},
            TimelineMax: {min: staticServerUrl + 'services/third-party/tweenmax/1.13.1/minified/TweenMax.min', source: staticServerUrl + 'services/third-party/tweenmax/1.13.1/uncompressed/TweenMax'},
            ScrollToPlugin: {min: staticServerUrl + 'services/third-party/tweenmax/1.13.1/minified/plugins/ScrollToPlugin.min', source: staticServerUrl + 'services/third-party/tweenmax/1.13.1/uncompressed/plugins/ScrollToPlugin'},
            skins: 'js/skins',
            ...
            SoundManager: 'js/vendor/soundmanager2/soundmanager2'
        },
        // generated
        packages: null,
        bundles: null
...
////////////////////////////////////////////////////////////////////////
    ...
    if (window.clientSideRender) {
        var packages = ['react', 'lodash', 'zepto', 'core', 'utils', 'layout', 'components', 'TweenMax', 'TimelineMax', 'ScrollToPlugin', 'skins', 'wixappsClassics', 'wixappsBuilder', 'wixappsCore', 'fonts', 'tpa', 'animations', 'bi', 'logger', 'color', 'swfobject', 'mousetrap'];
            ...
            function (p, ajaxHandler) {
                ...
                p.core.renderer.renderSite(siteModel, ajaxHandler, function (renderedReact) {
                    if (window.rendered) {
                        ...
                        window.rendered = p.react.renderComponent(renderedReact, document.getElementById("SITE_CONTAINER"));
